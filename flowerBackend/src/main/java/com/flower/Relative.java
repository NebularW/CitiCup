 ...
 * @title: Relative
 * @Author: Stanton JY
 * @Date: 2022/2/18 22:48
 */

//TODO:这是亲属关系转换器，用于家庭账户自动确认关系
public class Relative {
    ...
    public String do_count(String tmp) {
        String[][] relationshipData = new Relative().getRelationShipData();
        String[] array = tmp.split("的");
        int column = 0, row = 0;
